...
class reBotArmController(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("eef_streaming.diagnostics_enabled", False)
        self.declare_parameter("eef_streaming.publish_target_tf", False)
        self.declare_parameter("eef_streaming.diagnostics_detail", False)
